...
For more details about how to define and enable custom or default events in your Mule application, see xref:3.8@mule-runtime::business-events.adoc[Business Events].
