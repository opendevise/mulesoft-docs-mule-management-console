...
[NOTE]
https://www.mulesoft.com/legal/versioning-back-support-policy#mule-management-console[Mule Management Console (MMC) was deprecated in December 2015]. For more information, see the xref:release-notes::mule-runtime/mmc-migrator-tool.adoc[MMC Migrator Tool].
